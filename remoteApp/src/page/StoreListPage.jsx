import StoreInfo from "../data/ListStore"
...
function ListStore() {
    return(
        <div className="container px-36 mb-36">
            ...
            <p className="text-4xl font-bold mb-5 mt-2">Ưu đãi GrabFood tại <span className="text-[#00B14F]">Tp.Hồ Chí Minh</span></p>
            <div className="grid grid-cols-4 gap-6">
                {
                   StoreInfo.map(store => <Store storeImg={store.img} storeName={store.name} storeFood={store.food}
