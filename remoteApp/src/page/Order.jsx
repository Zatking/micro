    ...
    return(
        <div>
            <div className="container px-96">
                <p className="font-bold text-4xl mt-7">Bước cuối cùng - Thanh toán</p>
                <p className="font-bold text-xl my-5">Xôi Má Bải</p>
            </div>
            <div className="container bg-[#F7F7F7] px-96 py-5 space-y-5">
                <div className="bg-white rounded px-7 py-3 divide-y space-y-3">
                    ...
                    <div className="flex flex-row">
                        ...
                        <div className="basis-3/5 space-y-5 py-5">
                            <div>
                ...
                <div className="bg-white rounded px-7 py-3 divide-y space-y-3">
                    ...
                    <div className="flex flex-row py-5">
                        ...
                        <div className="basis-3/6 content-center">
                ...
                <div className="bg-white rounded px-7 py-3 divide-y space-y-3">
                    ...
                    <div className="flex flex-row py-5">
                        <div className="basis-4/6 pr-10 space-y-3">
                            <input className="border border-[#C0C0C0] hover:border-[#00B14F] rounded-lg w-full px-5 py-3" type="text" placeholder="Nhập mã khuyến mãi" />
            ...
            <div className="container px-96 py-5 sticky bottom-0 bg-white">
                <div className="flex flex-row">
