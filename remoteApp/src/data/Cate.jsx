import CateTypeOfFood from "../components/CateTypeOfFood";

function CateFood(){
    const ListTypeFood = [{img: "https://food-cms.grab.com/compressed_webp/cuisine/69/icons/FriedChicken_4251b520449049528751b74b4d05ffa1_1547819155005255038.webp",
    name: "Gà rán"},
...
{img: "https://food-cms.grab.com/compressed_webp/cuisine/157/icons/eb8ea703d1f84b218b79b0f860e99425_1562559054203677203.webp",
    ...
    return(
        ListTypeFood.map(ListTypeFood => <CateTypeOfFood cateImg={ListTypeFood.img} cateName={ListTypeFood.name} />)
    )
}
